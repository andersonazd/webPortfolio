<template>
  <app-layout>
    <!-- component -->
    <div
      class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-8 w-11/12 mx-auto"
    >
          <transition name="fade">
        <div
          v-if="mensaje"
          class="mensaje bg-green-600 mx-auto my-5 w-7/12 text-center"
        >
  ...
  <body class="bg-white text-gray-100">
    ...
    >
      <div class="flex flex-col justify-between">
        <div>
          <h2 class="text-4xl lg:text-5xl font-bold leading-tight">
            Hablemos de nuestro próximo trabajo!
          </h2>
          <div class="text-gray-700 mt-8">
            Pueden enviarme las solitudes o información que desees.
          </div>
        </div>
      ...
      <form @submit.prevent="enviarMensaje">
        ...
        <div
          v-if="mensaje"
          class="mensaje bg-green-600 mx-5 my-5 w-7/12 text-center"
        >
          Mensaje Enviado Correctamente.
        </div>
      </transition>  
...
export default {
  ...
  methods: {
    ...
    quitarMensaje() {
      setTimeout(() => ((this.mensaje = false), (this.errors = false)), 17000);
    },

    enviarMensaje() {
        axios
        .post("/contacto", this.form)
        .then((Response) => {
          this.mensaje = true;
          this.quitarMensaje();
        })
