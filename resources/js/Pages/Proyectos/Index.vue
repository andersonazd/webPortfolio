    ...
    <div>
      <div class="ml-12 flex items-center">
        <inertia-link
          ...
          :href="route('createproyecto')"
        >
          <span>Create Proyecto</span>
        </inertia-link>
      </div>
          ...
          >
            <thead class="text-white">
              ...
              >
                ...
                <th class="p-3 text-left">Link Proyecto</th>
            ...
            >
              <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
                ...
                <td
                  class="w-40 border-grey-light border hover:bg-gray-100 p-3 truncate"
                >
                <img
                :src="proyecto.image"
                class="rounded"
              ...
              />
                ...
                >
                  <inertia-link :href="route('editproyecto', proyecto.id)">
                    <span>Editar</span>
                  </inertia-link>
                </td>
                <td 
                ...
                >
                  <inertia-link @click="eliminando" class="" :href="route('deleteproyecto', proyecto.id)">
                    <span>{{eliminado}}</span>
                  </inertia-link>
                </td>
              </tr>
