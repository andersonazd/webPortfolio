  ...
  <app-layout>
    <div class="">
      ...
      <transition name="fade">
        ...
        >
          Proyecto Actualizado Correctamente, puedes seguir editando o regresar.
        </div>
      </transition>
      <transition name="fade">
        <div
...
export default {
  ...
  data() {
    return {
      form: {
        id: this.proyectos.id,
        name: this.proyectos.name,
        category_id: this.proyectos.category_id,
        description: this.proyectos.description,
        link: this.proyectos.link,
        image: this.proyectos.image,
      },
      imagepreview: this.proyectos.image,
      mensaje: false,
      errors: false,
    };
  },
  methods: {
    ...
    addProyect() {
      ...
      axios
        .post(`/addproyectos/${this.form.id}`, formData)
        .then((Response) => {
          this.mensaje = true;
          this.quitarMensaje();
        })
